...
describe('renderer internal-test build switch', () => {
  it('pins every renderer dependency to the desktop React 18 singleton', () => {
    ...
    expect(portable(config.resolve.alias['react$'])).toContain('/packages/desktop/node_modules/react/');
    expect(portable(config.resolve.alias['react-dom$'])).toContain('/packages/desktop/node_modules/react-dom/');
    expect(portable(config.resolve.alias['react/jsx-runtime$'])).toContain('/packages/desktop/node_modules/react/');
  });
