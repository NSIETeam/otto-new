...
// 4. Update the sandboxImageUri in the root package.json (optional, can be commented out if not needed)
...
// 6. Run `npm install` to update package-lock.json (skip scripts to avoid prepare hook).
