...
describe('ModuleWorkspace', () => {
  ...
  it.each([9, 10, 12])('keeps add-module as the last grid cell after %i modules', (count) => {
    ...
    expect(grid?.classList.contains(`otto-module-group__grid--rows-${Math.ceil((count + 1) / 3)}`)).toBe(true);
