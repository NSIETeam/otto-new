...
const bridge = {
  ...
  appVersion(): Promise<string> { return Promise.resolve('1.10.0-browser'); },
  updateCheck(): Promise<any> { return Promise.resolve({ status: 'up-to-date', currentVersion: '1.10.0', latestVersion: null }); },
