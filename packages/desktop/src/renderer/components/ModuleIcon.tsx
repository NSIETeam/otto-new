...
const MODULE_LINE_ICON_REGISTRY = {
  ...
  'park-flea-market': IconStore,
  'park-staff-tasks': IconClipboardList,
  'park-my-applications': IconHistory,
  'enterprise-memory': IconBrain,
  'auto-skill': IconWand,
  'skill-zone': IconStore,
  'office-work': IconBriefcaseBusiness,
  'office-presentation': IconLayoutDashboard,
  'office-meeting': IconMicrophone,
  'office-document': IconFile,
  'office-spreadsheet': IconDashboard,
  'office-pdf': IconFile,
  'office-dataviz': IconDashboard,
