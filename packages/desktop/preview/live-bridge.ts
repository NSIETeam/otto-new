...
const bridge = {
  ...
  appVersion(): Promise<string> { return Promise.resolve('1.9.18-browser'); },
  updateCheck(): Promise<any> { return Promise.resolve({ status: 'up-to-date', currentVersion: '1.9.18', latestVersion: null }); },
